// Sovereign patient lake — Nordic (Oslo). In-memory FHIR-ish store.
const http = require('http')
const patients = []
const REGION = process.env.REGION || 'Nordic (Oslo)'
http.createServer((req, res) => {
  ...
  send(200, { lake: 'nordic', region: REGION, sovereign: true, patients: patients.length })
