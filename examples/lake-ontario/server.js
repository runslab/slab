// Sovereign patient lake — Great Lakes (Toronto). In-memory FHIR-ish store.
const http = require('http')
const patients = []
const REGION = process.env.REGION || 'Great Lakes (Toronto)'
http.createServer((req, res) => {
  ...
  send(200, { lake: 'ontario', region: REGION, sovereign: true, patients: patients.length })
